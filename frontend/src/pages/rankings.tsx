...
export const Market = () => {
    ...
    return (
        <div
            ...
            <div className='flex justify-between'>
                ...
                <div className='px-10 pt-10 flex flex-col'>
                    ...
                    <div className='flex  gap-3'>
                        <Button onClick={() => setSelectedSection('rankings')} className={`${buttonStyle} ${selectedSection === 'rankings' ? 'text-black bg-[var(--color-purple)]' : buttonBorderStyle}`}>Rankings</Button>
                        <Button onClick={() => setSelectedSection('collections')} className={`${buttonStyle} ${selectedSection === 'collections' ? 'text-black bg-[var(--color-toxic)]' : buttonBorderStyle}`}>Collections</Button>
                        <Button onClick={() => setSelectedSection('hot')} className={`${buttonStyle} ${selectedSection === 'hot' ? 'text-black bg-[var(--color-orange)]' : buttonBorderStyle}`}>Hot NFTs</Button>
                    </div>
                </div>

                <img className={`${selectedSection == 'collections' ? 'w-52' : 'w-96'} h-auto mt-24 mr-[20%]`}
            ...
            <div className='h-20 w-full rounded-full absolute -bottom-10 bg-[var(--wui-color-modal-bg-base)]'/>
        </div>
    );
};